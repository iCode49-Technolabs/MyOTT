...
class UserDetail(models.Model):
    ...
    socialId  = models.CharField(max_length=100, verbose_name="Social ID", null=True)
    devicelId  = models.CharField(max_length=100, verbose_name="Device ID", null=True)
    deviceType  = models.CharField(max_length=100, verbose_name="Device Type", null=True)
    socialType  = models.CharField(max_length=100, verbose_name="Social Type", null=True)
    ...
    otpVerification = models.CharField(max_length=3, default='no',blank=True, null=True, verbose_name='OTP Verification')
    otpVerificationTime = models.DateTimeField(verbose_name='OTP Verification Time', blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class Avatar(models.Model):
    avatarName = models.CharField(max_length=100, verbose_name="Avatar Name", null=True)
    avatarImage = models.FileField(upload_to='OTT/static/image/avatar', verbose_name='Avatar Images', null=True, blank=True,
                             validators=[validators.validate_file_extension_image])    
    created_at = models.DateTimeField(auto_now_add=True)
     
    def __str__(self):
        return "%s" % self.avatarName
...
class Profile(models.Model):
    ...
    avatar = models.ForeignKey(Avatar, related_name="user_id", verbose_name="Avatar", null=True, on_delete=models.CASCADE, default=None)
...
class Series(models.Model):
    ...
    seriesCast = models.ManyToManyField(Cast,verbose_name="Cast", blank= True)
...
class Episode(models.Model):
    ...
    episodeDuration = models.CharField(max_length=50, verbose_name="Episode Durations", null=True)
    ...
    episodeThumbnail = models.FileField(upload_to='OTT/static/image/episode/thumbnail', verbose_name='Episode Thumbail', null=True, blank=True,
                             validators=[validators.validate_file_extension_image])
    episodeLink_360p = models.CharField(max_length=500, verbose_name="Episode Link 360p", null=True)
    episodeLink_480p = models.CharField(max_length=500, verbose_name="Episode Link 480p", null=True)
    episodeLink_720p = models.CharField(max_length=500, verbose_name="Episode Link 720p", null=True)
    episodeLink_1080p = models.CharField(max_length=500, verbose_name="Episode Link 1080p", null=True)
    ...
    episode_is_for18Plus = models.CharField(max_length=3, verbose_name="Episode is for 18+",null=True,)
    episodePublishType = models.CharField(max_length=5, verbose_name="Episode Publish Type", null=True,)
    laterEpisodeTime = models.TimeField(default=None, null=True,)
    laterEpisodeDate = models.DateField(default=None, null=True,)
    created_at = models.DateTimeField(auto_now_add=True)
...
class Wishlist(models.Model):
    ...
    mainUser = models.ForeignKey(UserDetail, verbose_name="Main User", on_delete=models.CASCADE, default=None)
    profileID = models.ForeignKey(Profile, verbose_name="Profile Name", on_delete=models.CASCADE, default=None)
